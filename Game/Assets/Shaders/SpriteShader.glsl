...
layout(location = 1)  vec4 a_TintColor;
layout(location = 2)  vec2 a_UVCoords;
...
void main()
{
    ...
    vo.TintColor   = a_TintColor;
    vo.UVCoords    = a_UVCoords;
...
void main()
{
    ...
    FragColor = texture(u_TextureSlots[vi.TextureSlot], vi.UVCoords * vi.TintColor);       
}