...
IncludeDirs["imguizmo"     ] = "%{wks.location}/ThirdParty/imguizmo"
IncludeDirs["glad"         ] = "%{wks.location}/ThirdParty/glad/Source"
IncludeDirs["glfw"         ] = "%{wks.location}/ThirdParty/glfw/include"
IncludeDirs["stb"          ] = "%{wks.location}/ThirdParty/stb/Source"
IncludeDirs["rttr"         ] = "%{wks.location}/ThirdParty/rttr/src"
IncludeDirs["rapidjson"    ] = "%{wks.location}/ThirdParty/rapidjson/include"
IncludeDirs["openal"       ] = "%{wks.location}/ThirdParty/openal/include"
...
IncludeDirs["entt"         ] = "%{wks.location}/ThirdParty/entt/Source"