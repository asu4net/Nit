...
namespace Nit
{
    ...
    void OpenGLFramebuffer::Invalidate()
    {
        ...
        {
            NIT_CHECK((m_ColorAttachments.size() <= 4), "Invalid size!");
    ...
    void OpenGLFramebuffer::Resize(uint32_t width, uint32_t height)
    {
        ...
        {
            NIT_LOG_WARN("Attempted to rezize Framebuffer to %i, %i", width, height);
            return;
        }
    ...
    {
        NIT_CHECK((attachmentIndex < m_ColorAttachments.size()), "Invalid index!");
